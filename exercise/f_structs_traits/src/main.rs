...
fn main() {
    ...
    // Grapes struct.
    //
    let mut grapes: Grapes = Grapes { amount_left: 100 };
    grapes.bite();
    ...
    //
    bunny_nibbles(&mut carrot, Some(33));
    println!("Bunny nibbles for awhile: {:?}", carrot);
    bunny_nibbles(&mut grapes, None);
    println!("Bunny nibbles for awhile: {:?}", grapes);
}

fn bunny_nibbles<T: Bite>(eatable: &mut T, amount: Option<i32>) {
